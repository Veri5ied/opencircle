    ...
    >
      ...
      >
        <div className="px-5 py-4 border-b border-modal flex items-center justify-between">
          <div>
            <div className="f-display font-semibold text-lg text-primary">
              API Keys
            </div>
            <div className="f-body text-xs text-nav2 mt-0.5">
        ...
        <div>
          {MODELS.map((model, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center gap-2.5 ${isEditing ? "mb-2.5" : ""}`}
                >
                  <ModelBadge model={model} />
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="f-mono text-xs text-body font-medium">
                        {model.name}
                      </span>
                      <span
                    ...
                    <div className="f-mono text-[10px] text-dim mt-0.5">
                      {model.keyLabel}
                    </div>
                  </div>
                  <button
        ...
        <div className="px-5 py-3 border-t border-app flex items-center gap-2">
          ...
          <span className="f-body text-[11px] text-dim">
            Keys never leave your browser. No account required.
          </span>
        </div>
      </div>
    </div>
